...
\begin{figure}\label{fig:insert-expand}
\centering
\subfloat[Initial state]{\includegraphics[width=.5\textwidth]{expand-0.png}}
\subfloat[Table is expanded]{\includegraphics[width=.5\textwidth]{expand-1.png}}
\newline
\subfloat[Dummy node for new bucket inserted]{\includegraphics[width=.5\textwidth]{expand-2.png}}
\subfloat[Table entry points to bucket node]{\includegraphics[width=.5\textwidth]{expand-3.png}}
