...
\begin{enumerate}[label={}]
    ...
    \item \textbf{\Autoref{ch:discussion}} discusses these results in relation to the thesis, and explores experiences and lessons lerned.
\end{enumerate}
...
\@x{\@s{12.29} \.{\cup}}%
 ...
 MaxID ]}%
\end{tlatex}
    \caption{The failure invariants as TLA properties}
...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{%
        ...
        & 4 & 2 & 2 & 153 & 665,993,030& 04:22:12 & No signs of converging\\
        \hline
        \textit{InsertFails} & 2 & 2 & 2 & 20 & 64,000 & 00:01:07 & Out of heap space\\
        \hline
        \textit{DeleteFails} & 2 & 2 & 2 & 25 & 153,370& 00:02:12 & GC overhead limit exceeded\\ 
        \hline
    \end{tabular}}
...
\\\\
problem: how certain can we be that the specification and invariants prove what we mean them to?
\\\\
...
\\\\
Model checking with TLC can be used to exhaustively show the correctness of a structure on a small subset of the sample space. The results on this subset correspond to the properties formally proven by Shalev et al. with the exception of operation failures.
